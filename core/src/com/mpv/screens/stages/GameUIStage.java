...
public class GameUIStage extends Stage {
    ...
    public static PauseDialog pauseDialog = new PauseDialog("", Assets.skin,
	    "dialog");
    public static FinishDialog finishDialog = new FinishDialog("", Assets.skin,
	    "dialog");
    public static FailedDialog failedDialog = new FailedDialog("", Assets.skin,
	    "dialog");
    public static StartDialog startDialog = new StartDialog("", Assets.skin,
	    "dialog");
	...
	controlPanel.top();
	controlPanel.add(new Image(Assets.skin.getDrawable("timer"))).size(
		GVars.scrWidth / 12f);
	controlPanel.add(labelTime).expand(true, false).height(getWidth() / 13)
		.width(getWidth() / 4.3f).left();
